...
source_cam_rtsp_url = "rtsp://phoom2545:phoom12641@192.168.2.58/stream1"

plate_detection_model = YOLO('model/license_plate.pt').to('cuda')       # Read license plate from the images or video
read_data_model = YOLO('model/data_plate.pt').to('cuda')           # Read info inside license plate
...
read_license_info(source_cam_rtsp_url)